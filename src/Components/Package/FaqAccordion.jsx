...
function FaqAccordion() {
  ...
  return (
    ...
    >
      <Grow in={active} {...(active ? { timeout: 800 } : {})}>
        <div>
          <Accordion
          ...
          >
            ...
            <AccordionDetails className={classes.bgColor}>
              <Typography className={classes.text}>
                ...
                aliquam mollitia corporis voluptatem ex possimus maiores
                voluptates excepturi sed voluptatibus suscipit nisi error
                accusamus libero iste non, neque molestiae sint? Cum quae
                repudiandae nulla iusto quaerat earum sequi ullam quisquam.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion
